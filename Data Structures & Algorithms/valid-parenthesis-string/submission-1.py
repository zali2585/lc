class Solution:
    def checkValidString(self, s: str) -> bool:
        ...
        return low == 0
""" 
GREEDY RECOGNITION: at each * u have multiple choices of what to do () or empty. instead of committing to one, u can keep the best/worst possible range of states, adjusting to prevent impossible ones
choices now affect future feasibility, states can be compressed to min/max
"""
